...
public:
    tqueue_uint(int _size, Degree D)
    {
    ...
    void enqueue(unsigned int value, Degree d)
    {
        if (isFull())
        {
            cout << "Queue Overflow" << endl;
    ...
    unsigned int get_array_front_value()
    {
        return array.get_pointer_value(front);
    }
    //
    unsigned int get_array_rear_value()
    {
        return array.get_pointer_value(rear);
    }
    tarray_uint get_array()
    {
        return array;
    }
    int get_size()
...
void scanQueue(tqueue_uint &obj, int size)
{
...
void scanQueue(tqueue_uint &obj)
{
    int _size;
...
void printQueue(tqueue_uint &obj)
{
