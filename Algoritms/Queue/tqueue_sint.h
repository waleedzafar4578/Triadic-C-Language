...
public:
    tqueue_sint(int _size, Degree D)
    {
    ...
    void enqueue(short int value, Degree d)
    {
        if (isFull())
        {
            cout << "Queue Overflow" << endl;
    ...
    short int get_array_front_value()
    {
        return array.get_pointer_value(front);
    }
    //
    short int get_array_rear_value()
    {
        return array.get_pointer_value(rear);
    }
    tarray_sint get_array()
    {
        return array;
    }
    int get_size()
...
void scanQueue(tqueue_sint &obj, int size)
{
...
void scanQueue(tqueue_sint &obj)
{
    int _size;
...
void printQueue(tqueue_sint &obj)
{
