...
public:
    tqueue_lint(int _size, Degree D)
    {
    ...
    void enqueue(long int value, Degree d)
    {
        if (isFull())
        {
            cout << "Queue Overflow" << endl;
    ...
    long int get_array_front_value()
    {
        return array.get_pointer_value(front);
    }
    //
    long int get_array_rear_value()
    {
        return array.get_pointer_value(rear);
    }
    tarray_lint get_array()
    {
        return array;
    }
    int get_size()
...
void scanQueue(tqueue_lint &obj, int size)
{
...
void scanQueue(tqueue_lint &obj)
{
    int _size;
...
void printQueue(tqueue_lint &obj)
{
