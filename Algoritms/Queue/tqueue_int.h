...
public:
    ...
    int get_array_front_value()
    {
        return array.get_pointer_value(front);
    }
    // 
    int get_array_rear_value()
    {
...
void scanQueue(tqueue_int &obj, int size)
{
...
void printQueue(tqueue_int &obj)
{
