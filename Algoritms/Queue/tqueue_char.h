...
public:
    tqueue_char(int _size, Degree D)
    {
    ...
    void enqueue(char value , Degree d)
    {
        if (isFull())
        {
            cout << "Queue Overflow" << endl;
    ...
    char get_array_front_value()
    {
        return array.get_pointer_value(front);
    }
    // 
    char get_array_rear_value()
    {
        return array.get_pointer_value(rear);
    }
    tarray_char get_array()
    {
        return array;
    }
    int get_size()
...
void scanQueue(tqueue_char &obj, int size)
{
...
void scanQueue(tqueue_char &obj)
{
    int _size;
...
void printQueue(tqueue_char &obj)
{
