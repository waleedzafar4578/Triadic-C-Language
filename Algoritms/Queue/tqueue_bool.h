...
public:
    tqueue_bool(int _size, Degree D)
    {
    ...
    void enqueue(bool value , Degree d)
    {
        if (isFull())
        {
            cout << "Queue Overflow" << endl;
    ...
    bool get_array_front_value()
    {
        return array.get_pointer_value(front);
    }
    // 
    bool get_array_rear_value()
    {
        return array.get_pointer_value(rear);
    }
    tarray_bool get_array()
    {
        return array;
    }
    int get_size()
...
void scanQueue(tqueue_bool &obj, int size)
{
...
void scanQueue(tqueue_bool &obj)
{
    int _size;
...
void printQueue(tqueue_bool &obj)
{
