...
void merge2(tarray_int &array, int l, int m, int r)
{
    int i, j, k, nl, nr;
...
void mergeSort2(tarray_int &array, int l, int r)
{
    int m;
    if (l < r)
    {
...
void tmerge2(tarray_int &array, int size)
{
    int t = 0, l = 0, f = 0;
    ...
    //cout << i1 << " " << i2 << " " << i3 << endl;
    i1--, i2--, i3--;
    mergeSort2(tarr, 0, i2);
    mergeSort2(farr, 0, i3);
    mergeSort2(larr, 0, i1);
