...
void Heapify3(tarray_int &obj, int size, int index)
{
    int largest = index;
    int left = 2 * index + 1;
    int right = 2 * index + 2;
    ...
    if (largest != index)
    {
        ...
        Heapify3(obj, size, largest);
    }
}
void HeapSort3(tarray_int &obj, int size)
{
...
void t_heapsort_int3(tarray_int &obj, int size)
{
    int filter1_size = 0;
    ...
    HeapSort3(filter2f, filter2f_index);
    HeapSort3(filter2l, filter2l_index);
    HeapSort3(filter2t, filter2t_index);
