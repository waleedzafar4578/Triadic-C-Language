/* This file defines Triadic Short Integer Array and relevant functions:

create, array size, get and set array, reset array, array's components w.r.t degrees, print and scan array

*/

#ifndef tarray_sint_h
#define tarray_sint_h
...
public:
    ...
    void set_pointer_value(int &index, short int&v)
    {
    ...
    short int get_pointer_value(int index)
    {
    ...
    void input(short int val, Degree d, int index)
    {
...
void icomponent(tarray_sint &obj)
{
    obj.compnent();
}
...
void set_idegree(tarray_sint &obj, int index, Degree d)
{
...
void set_idegree(tarray_sint &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_vdegree(tarray_sint &obj, int index, Degree d)
{
...
void set_vdegree(tarray_sint &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_value(tarray_sint &obj, int index, short int val)
{
...
void set_value(tarray_sint &obj, int index)
{
    short int val;
    cout << "Value:";
    cin >> val;
...
void t_scan(tarray_sint &obj, int index)
{
...
void t_scan(tarray_sint &obj, int sindex, int eindex)
{
...
void t_print(tarray_sint &obj, int index)
{
    if (obj.g_indexD(index) == T)
    {
...
void t_print(tarray_sint &obj, int sindex, int eindex)
{
