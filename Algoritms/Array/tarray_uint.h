/* This file defines Triadic Unsigned Integer Array and relevant functions:

create, array size, get and set array, reset array, array's components w.r.t degrees, print and scan array

*/

#ifndef tarray_uint_h
#define tarray_uint_h
...
public:
    ...
    void set_pointer_value(int &index, unsigned int&v)
    {
    ...
    unsigned int get_pointer_value(int index)
    {
    ...
    void input(unsigned int val, Degree d, int index)
    {
...
void icomponent(tarray_uint &obj)
{
    obj.compnent();
}
...
void set_idegree(tarray_uint &obj, int index, Degree d)
{
...
void set_idegree(tarray_uint &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_vdegree(tarray_uint &obj, int index, Degree d)
{
...
void set_vdegree(tarray_uint &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_value(tarray_uint &obj, int index, unsigned int val)
{
...
void set_value(tarray_uint &obj, int index)
{
    unsigned int val;
    cout << "Value:";
    cin >> val;
...
void t_scan(tarray_uint &obj, int index)
{
...
void t_scan(tarray_uint &obj, int sindex, int eindex)
{
...
void t_print(tarray_uint &obj, int index)
{
    if (obj.g_indexD(index) == T)
    {
...
void t_print(tarray_uint &obj, int sindex, int eindex)
{
