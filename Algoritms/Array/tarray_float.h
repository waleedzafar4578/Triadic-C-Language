/* This file defines Triadic Float Array and relevant functions:

create, array size, get and set array, reset array, array's components w.r.t degrees, print and scan array

*/

#ifndef tarray_float_h
#define tarray_float_h
...
public:
    ...
    tarray_float(int size, Degree d)
    {
        index = 0;
    ...
    tp_float get_pointer(int index)
    {
        return arr[index];
    }
    ...
    void set_pointer_value(int &index, float&v)
    {
    ...
    float get_pointer_value(int index)
    {
    ...
    void input(float val, Degree d, int index)
    {
...
void icomponent(tarray_float &obj)
{
    obj.compnent();
}
...
void set_idegree(tarray_float &obj, int index, Degree d)
{
...
void set_idegree(tarray_float &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_vdegree(tarray_float &obj, int index, Degree d)
{
...
void set_vdegree(tarray_float &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_value(tarray_float &obj, int index, float val)
{
...
void set_value(tarray_float &obj, int index)
{
    float val;
    cout << "Value:";
    cin >> val;
...
void t_scan(tarray_float &obj, int index)
{
...
void t_scan(tarray_float &obj, int sindex, int eindex)
{
...
void t_print(tarray_float &obj, int index)
{
    if (obj.g_indexD(index) == T)
    {
...
void t_print(tarray_float &obj, int sindex, int eindex)
{
