/* This file defines Triadic Integer Array and relevant functions: 
...
public:				
    ...
    void set_pointer_value(int &index, int v)
    {
    ...
    int get_pointer_value(int index)
    {
    ...
    void input(int val, Degree d, int index)
    {
...
void icomponent(tarray_int &obj)
{
    obj.compnent();
}
...
void set_idegree(tarray_int &obj, int index, Degree d)
{
...
void set_idegree(tarray_int &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_vdegree(tarray_int &obj, int index, Degree d)
{
    obj.set_pointer_value_degree(index, d);
}
	// Set degree of the Triadic Pointer's value using console
 
void set_vdegree(tarray_int &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_value(tarray_int &obj, int index, int val)
{
    obj.set_pointer_value(index, val);
}

	// Set value of the Triadic Pointer's value using console
void set_value(tarray_int &obj, int index)
{
    int val;
    cout << "Value:";
    cin >> val;
...
void t_scan(tarray_int &obj, int index)
{
...
here:
	...
	// Scan (or read) Array's values and their degrees within starting and ending indices rang

void t_scan(tarray_int &obj, int sindex, int eindex)
{
...
void t_print(tarray_int &obj, int index)
{
    if (obj.g_indexD(index) == T)
    {
...
void t_print(tarray_int &obj, int sindex, int eindex)
{
