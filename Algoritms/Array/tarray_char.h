/* This file defines Triadic Character Array and relevant functions:

create, array size, get and set array, reset array, array's components w.r.t degrees, print and scan array

*/

#ifndef tarray_char_h
#define tarray_char_h
...
public:
    ...
    void set_pointer_value(int &index, char&v)
    {
    ...
    char get_pointer_value(int index)
    {
    ...
    void input(char val, Degree d, int index)
    {
...
void icomponent(tarray_char &obj)
{
    obj.compnent();
}
...
void set_idegree(tarray_char &obj, int index, Degree d)
{
...
void set_idegree(tarray_char &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_vdegree(tarray_char &obj, int index, Degree d)
{
...
void set_vdegree(tarray_char &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_value(tarray_char &obj, int index, char val)
{
...
void set_value(tarray_char &obj, int index)
{
    char val;
    cout << "Value:";
    cin >> val;
...
void t_scan(tarray_char &obj, int index)
{
...
void t_scan(tarray_char &obj, int sindex, int eindex)
{
...
void t_print(tarray_char &obj, int index)
{
    if (obj.g_indexD(index) == T)
    {
...
void t_print(tarray_char &obj, int sindex, int eindex)
{
