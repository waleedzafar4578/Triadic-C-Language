/* This file defines Triadic Boolean Array and relevant functions:

create, array size, get and set array, reset array, array's components w.r.t degrees, print and scan array

*/

#ifndef tarray_bool_h
#define tarray_bool_h
...
public:
    ...
    void set_pointer_value(int &index, bool &v)
    {
    ...
    bool get_pointer_value(int index)
    {
    ...
    void input(bool val, Degree d, int index)
    {
...
void icomponent(tarray_bool &obj)
{
    obj.compnent();
}
...
void set_idegree(tarray_bool &obj, int index, Degree d)
{
    obj.s_indexD(index, d);
}

// Set degree of the Triadic Pointer's Index using console
void set_idegree(tarray_bool &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_vdegree(tarray_bool &obj, int index, Degree d)
{
...
void set_vdegree(tarray_bool &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_value(tarray_bool &obj, int index, bool val)
{
...
void set_value(tarray_bool &obj, int index)
{
    bool val;
    cout << "Value:";
    cin >> val;
...
void t_scan(tarray_bool &obj, int index)
{
...
void t_scan(tarray_bool &obj, int sindex, int eindex)
{
...
void t_print(tarray_bool &obj, int index)
{
    if (obj.g_indexD(index) == T)
    {
...
void t_print(tarray_bool &obj, int sindex, int eindex)
{
