...
public:
    ...
    tarray_ldouble(int size, Degree d)
    {
        index = 0;
    ...
    tp_ldouble get_pointer(int index)
    {
        return arr[index];
    }
    ...
    void set_pointer_value(int &index, long double&v)
    {
    ...
    long double get_pointer_value(int index)
    {
    ...
    void input(long double val, Degree d, int index)
    {
...
void icomponent(tarray_ldouble &obj)
{
    obj.compnent();
}
...
void set_idegree(tarray_ldouble &obj, int index, Degree d)
{
...
void set_idegree(tarray_ldouble &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_vdegree(tarray_ldouble &obj, int index, Degree d)
{
...
void set_vdegree(tarray_ldouble &obj, int index)
{
    char c;
    cout << "Degree:";
    cin >> c;
...
void set_value(tarray_ldouble &obj, int index, long double val)
{
...
void set_value(tarray_ldouble &obj, int index)
{
    long double val;
    cout << "Value:";
    cin >> val;
...
void t_scan(tarray_ldouble &obj, int index)
{
...
void t_scan(tarray_ldouble &obj, int sindex, int eindex)
{
...
void t_scan(tarray_ldouble &obj)
{
...
void t_print(tarray_ldouble &obj, int index)
{
    if (obj.g_indexD(index) == T)
    {
...
void t_print(tarray_ldouble &obj, int sindex, int eindex)
{
...
void t_print(tarray_ldouble &obj)
{
    for(int i = 0; i < obj.get_size(); i++)
    {
        if (obj.g_indexD(i) == T)
